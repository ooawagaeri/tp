...
public class UniqueJobList implements Iterable<Job> {
    ...
    public void setJobs(seedu.address.model.job.UniqueJobList replacement) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
            || (other instanceof seedu.address.model.job.UniqueJobList // instanceof handles nulls
            && internalList.equals(((seedu.address.model.job.UniqueJobList) other).internalList));
    }
