...
import seedu.address.storage.JsonMyCrmStorage;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonMyCrmStorage addressBookStorage =
                new JsonMyCrmStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        expectedModel.addContact(expectedPerson);
     ...
     */
    private static class JsonAddressBookIoExceptionThrowingStub extends JsonMyCrmStorage {
